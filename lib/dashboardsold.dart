...
class DashboardSoldPage extends StatefulWidget {
  const DashboardSoldPage({Key? key}) : super(key: key);

  @override
  _DashboardSoldPageState createState() => _DashboardSoldPageState();
}

class _DashboardSoldPageState extends State<DashboardSoldPage> {
  List listings = [];
  bool isLoading = true;
  ...
  Future<void> fetchListings() async {
    final response = await http.get(Uri.parse('http://10.0.2.2:8000/api/listingssold'));
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      Icon(Icons.sell, color: Colors.blue, size: 30),
                      const SizedBox(height: 5),
                      const Text(
                        'Sold',
                        style: TextStyle(
