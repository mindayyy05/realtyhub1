...
class TownhousePage extends StatefulWidget {
  const TownhousePage({Key? key}) : super(key: key);

  @override
  _TownhousePageState createState() => _TownhousePageState();
}

class _TownhousePageState extends State<TownhousePage> {
  List listings = [];
  ...
  Future<void> fetchListings() async {
    final url = Uri.parse('http://10.0.2.2:8000/api/townhouselistings');
            ...
            if (listing['images'] != null) {
              try {
                ...
                listing['images'] = imagePaths.map((path) {
                  return 'http://10.0.2.2:8000/api/townhouselistings';
                }).toList();
              } catch (e) {
                listing['images'] = [];
              }
