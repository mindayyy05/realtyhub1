...
class AgencyDetailPage3 extends StatelessWidget {
  const AgencyDetailPage3({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Agency Name 3'), // Replace with actual agency name
        leading: IconButton(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/images/realestateagency3.png', // Replace with your agency logo
